...
// import '../../styles/addRecipe.css'; // Import the same CSS file
...
//   // Initialize the form with the recipe data if it exists
//   useEffect(() => {
//     if (recipe) {
//       setUpdatedRecipe({
...
//       navigate(`/${recipe.mode}/${recipe.category.replace(/\s+/g, '-')}/${updatedRecipe.recipeTitle.replace(/\s+/g, '-')}`);
//     }
//   };
