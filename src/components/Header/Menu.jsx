      ...
      <ul>
        ...
        <li className="dropdown">
          ...
          <div className="dropdown-content">
            <p>
              <NavLink to="/normal" onClick={() => setSelectedMode("normal")}>
                Normal
              </NavLink>
            </p>
            <p>
              <NavLink to="/diet" onClick={() => setSelectedMode("diet")}>
                Diet
              </NavLink>
            </p>
            <p>
              <NavLink
                to="/lactose-free"
                onClick={() => setSelectedMode("lactose-free")}
              >
                Lactose-free
              </NavLink>
            </p>
        ...
        {role === "admin" && (
          <li className="dropdown">
            ...
            <div className="dropdown-content">
              ...
              <p>
                <NavLink to="/manage-recepies">Manage Recipes</NavLink>
              </p>
            </div>
          </li>
        )}
